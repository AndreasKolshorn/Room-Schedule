...
/// <summary>
/// Summary description for BreadCrumbStudentReq
/// </summary>
public class BreadCrumbStudentReq 
{
    ...
    public BreadCrumbStudentReq(string programAreaName) 
    {
        Base = "Student : Requirement";
    ...
    public string GetMessage()
    {
        ...
        switch (UserEvent)
        {
            ...
            case (int) eventID.panelAdd:
                msg = Base + "<font color = orange><B>" + " ADD " + "</B></font>"
                    + studentName + " " + courseName + " "
                    + selectedCell;
                break;
            case (int) eventID.panelEdit:
                msg = Base + " : Edit : "+ selectedSlotStudentName ;
                break;
