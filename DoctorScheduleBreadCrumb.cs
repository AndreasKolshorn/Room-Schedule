...
/// </summary>
public class DoctorScheduleBreadCrumb 
{
	...
	public DoctorScheduleBreadCrumb(string programAreaName) 
    {
        Base = "Doctor : Schedule :" + programAreaName;
    ...
    public void SetDoctorSelected(StudentBasic student, int userEvent)
    {
        selectedStudentName = " > " + student.Lastname + ", " + student.Firstname;
        selectedCourseName = "";
        this.userEvent = userEvent;
