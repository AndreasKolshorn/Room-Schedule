...
/// <summary>
/// Summary description for StudentCourse
/// </summary>
public class StudentCourse
{
    ...
    public bool SQL_GetStudentsPossibleCourseList(List<StudentCourse> studentCourse, int studentUID)
    {
...
//                    , Convert.ToInt32(reader["CourseID"])
    ...
    public bool SQL_GetStudentsCurrentCourseList(List<StudentCourse> studentCourse, int studentUID)
    {
        // Populate program object with all program shifts required.
        bool haveRecord = false;
